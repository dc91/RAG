...
def get_results_filenames():
    if MULTIPROCESSING:
        ...
        RESULTS_CSV_NAME = f"{RESULTS_DIRECTORY}/BASELINE_384_Chunk_25_Overlap_no_tol.csv"
        RESULTS_EXCEL_NAME = f"{RESULTS_DIRECTORY}/BASELINE_384_Chunk_25_Overlap_no_tol.xlsx"
